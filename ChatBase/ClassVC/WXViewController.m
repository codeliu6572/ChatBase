...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row % 2 == 0) {
        WXLeftCell *cell = [tableView dequeueReusableCellWithIdentifier:@"leftWXCell"];
        if (!cell) {
            cell = [[WXLeftCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"leftWXCell"];
        }
    ...
    {
        WXRightCell *cell = [tableView dequeueReusableCellWithIdentifier:@"rightWXCell"];
        if (!cell) {
            cell = [[WXRightCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"rightWXCell"];
        }
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        [cell refreshCellWithText:text];
        return cell;
